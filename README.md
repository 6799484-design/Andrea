...
<body>
  ...
  <div class="topnav">
    ...
    <a href="#">MISION</a>
    <a href="#">VISION</a>
	<a href="https://www.nintendo.com/us/">EmpresaAndrea</a>
    <a href=""></a>
  </div>
  <!-- cuerpo de la pagina -->
  <div class="row">`
    <div class="row__column side">
      <h2>PASA A NUESTRO LOCAL</h2>
      <p> Le ofrecemos zapatos de calidad.</p>
    </div>
    <div class="row__column middle">
      <h2>Accesorios</h2>
      <p>todos modelos de tacones</p>
    </div>
    <div class="row__column side">
      <h2>TACONES</h2>
      <p></p>
  ...
  <audio controls> <source src="\Audio.mp3" type="Audio/mp3"> Tu navegador no soporta audio HTML5. </audio>
   ...
   <img src="OIP.png" width="400" height="200"/>

     <video width="600" height="400" controls>
    <source src="Video de WhatsApp 2025-08-03 a las 14.15.08_4247f09e.mp4"> 
       </video>
